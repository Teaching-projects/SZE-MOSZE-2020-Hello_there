...
Hero::Hero(const std::string &name, int hp, int dmg, double atkCooldown, const int xp_per_lvl, const int hp_per_lvl, const int dmg_per_lvl, const double cdr_per_lvl)
